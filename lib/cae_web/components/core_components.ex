defmodule CaeWeb.CoreComponents do
  @moduledoc """
  ...
  use Gettext, backend: CaeWeb.Gettext
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(CaeWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(CaeWeb.Gettext, "errors", msg, opts)
    end
  end
